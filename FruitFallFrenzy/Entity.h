...
using ComponentTuple = std::tuple<CSprite, CAnimation, CState, CTransform, CBoundingBox, CInput, CAutoPilot, CSlowDownEffect, CMagnetEffect, CScorePopup, CStunned, CTextPopup>;
